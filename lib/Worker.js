...
function createClient(port,ip, opts, db){
...
function MessageWorker(opts){
  var opts = opts || {};
  var redisport = opts.redisport || null;
  ...
  this.publisher = createClient(redisport,redishost, redisopts, redisdb);
  this.subscriber = createClient(redisport,redishost, redisopts, redisdb);
}
